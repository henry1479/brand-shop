            ...
            <ul class="products__list">
                <li class="products__item">
                    <div class="products__overlay-wrapper">
                        ...
                        <img src="img/style-1.png" alt="style-1" class="products__item-image" width="360" height="420">
                    </div>
                ...
                <li class="products__item">
                    ...
                    <img src="img/style-2.png" alt="style-2" class="products__item-image" width="360" height="420">
                    <h3 class="products__item-heading">ellery x m'o capsule</h3>
                    <p class="products__item-text">Known for her sculptural takes on traditional tailoring, Australian
                        arbiter of cool Kym Ellery teams up with Moda Operandi.</p>
                    <p class="products__item-price">$52.00</p>
                ...
                <li class="products__item">
                    ...
                    <img src="img/style-3.png" alt="style-3" class="products__item-image" width="360" height="420">
                    <h3 class="products__item-heading">ellery x m'o capsule</h3>
                    <p class="products__item-text">Known for her sculptural takes on traditional tailoring, Australian
                        arbiter of cool Kym Ellery teams up with Moda Operandi.</p>
                    <p class="products__item-price">$52.00</p>
                ...
                <li class="products__item">
                    ...
                    <img src="img/style-4.png" alt="style-4" class="products__item-image" width="360" height="420">
                    <h3 class="products__item-heading">ellery x m'o capsule</h3>
                    <p class="products__item-text">Known for her sculptural takes on traditional tailoring, Australian
                        arbiter of cool Kym Ellery teams up with Moda Operandi.</p>
                    <p class="products__item-price">$52.00</p>
                ...
                <li class="products__item">
                    ...
                    <img src="img/style-6.png" alt="style-6" class="products__item-image" width="360" height="420">
                    <h3 class="products__item-heading">ellery x m'o capsule</h3>
                    <p class="products__item-text">Known for her sculptural takes on traditional tailoring, Australian
                        arbiter of cool Kym Ellery teams up with Moda Operandi.</p>
                    <p class="products__item-price">$52.00</p>
                ...
                <li class="products__item">
                    ...
                    <img src="img/style-5.png" alt="style-5" class="products__item-image" width="360" height="420">
                    <h3 class="products__item-heading">ellery x m'o capsule</h3>
                    <p class="products__item-text">Known for her sculptural takes on traditional tailoring, Australian
                        arbiter of cool Kym Ellery teams up with Moda Operandi.</p>
                    <p class="products__item-price">$52.00</p>
