            ...
            <div class="cart-content__common-wrapper">
                ...
                ?>
                    <ul class="cart-content__list">
                        ...
                        <li class="cart-content__item">
                            <button class="cart-content__cross" type="button">
                    ...
                    <div class="cart-content__buttons-wrapper">
                        ...
                        <a href="#" class="cart-content__redirect">Continue shopping</a>
                    </div>
                </div>
