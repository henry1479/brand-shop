        ...
        <div class="container">
            <div class="header__wrapper">
                ...
                <div class="header__controls">
                    ...
                    <a class="header__link header__cart-link" href="cart.html">
        ...
        <section class="content container">
            <div class="content__wrapper">
                <div class="content__wrapper-form">
                    <form action="#" method="GET" class="content__form">
                        <fieldset class="content__group">
                            <legend>Your name</legend>
                            <input class="content__form-name" type="text" id="name" placeholder="First name">
                        ...
                        <fieldset class="content__group">
                            ...
                            <input class="content__form-name" type="text" id="details" placeholder="Email">
                            <input type="text" class="content__form-name" placeholder="Password">
                        </fieldset>
